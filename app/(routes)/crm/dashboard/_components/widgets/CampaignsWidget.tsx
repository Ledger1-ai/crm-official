...
import NewProjectDialog from "@/app/(routes)/campaigns/dialogs/NewProject";
...
export const CampaignsWidget = ({ projects: initialProjects }: CampaignsWidgetProps) => {
                    ...
                    filteredProjects.map((item) => (
                        ...
                        >
                            ...
                            <div className="shrink-0 pt-1">
                                <Link href={`/campaigns/boards/${item.board.id}`}>
                                    <Button
                                        size="icon"
                                        variant="ghost"
